    ...
    <div className="min-h-screen bg-[#1a1f26] text-white">
      ...
      <div id="message-section" className="container mx-auto px-6 lg:px-10 py-16 text-center">
        ...
        <p className="text-lg text-[#E7EBEE] mb-8">
          We currently don’t have any job openings available. However, stay tuned by visiting us regularly for future opportunities. We’re always looking for talented individuals to join our team!
        </p>
        <Link
          to="/contact"
